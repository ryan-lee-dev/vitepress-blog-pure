<template>
    ...
    <div class="site-footer">
        Copyright © 2025 <a class="vitepress" :href="website">{{ webTitle }}</a> | <script async="" src="//busuanzi.ibruce.info/busuanzi/2.3/busuanzi.pure.mini.js"></script> Viewed: <span id="busuanzi_value_site_pv"></span> <br />
